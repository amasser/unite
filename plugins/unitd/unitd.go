...
var sampleConfig = `
	## The address of the monitoring endpoint of the unite broker
...
func (s *Stats) Description() string {
	return "Provides metrics about the state of a unite server"
}
...
func init() {
	inputs.Add("unite", func() telegraf.Input {
		return &Stats{
			Server: "http://localhost:6060",
		}
	})
